        ...
        <div
            className={`${
                isNotificationDrawerOpen
                    ? 'transform translate-x-0'
                    : 'transform -translate-x-full'
            } fixed top-0 right-0 z-50 w-80  p-6 transition-transform duration-300 ease-in-out`}
        >
            <>
                {user && filteredNotifications && filteredNotifications.length > 0 ? (
                    <div className="flex flex-col gap-6">
                                    ...
                                    return (
                                        ...
                                        > Notifications
                                            <p
                                                className="absolute top-4 right-6 cursor-pointer"
                                                onClick={() =>
                                                    onXClick(notification.uniqueid)
                                                }
                                            >
                                                X
                                            </p>
                                ...
                                case 'docExpirationReminder':
                                    return (
                                        ...
                                        >
                                            ...
                                            <div className="flex justify-end">
                                                <UpdateNowButton
                                                    sectionName={notification.category}
                                                />
                                            </div>
                                        </div>
                                    );
                    ...
                    <div className="flex flex-col gap-5 text-center "> Notifications
                        <p className="text-center text-gray-500 text-xl">
                            You're all caught up!{' '}
                        </p>
                        <p className="text-center text-gray-500 text-xl">
