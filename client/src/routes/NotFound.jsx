...
export const NotFound = () => {
    ...
    return (
        <div className="flex flex-col justify-center items-center px-[50px] md:px-[50px] sm:px-[200px] py-20 gap-10 pt-20 min-h-screen w-full bg-mediumish-green">
            <h1 className="font-fira text-8xl pb-20">404</h1>
            <h1 className="font-fira text-3xl text-center">
                Oops! It looks like you took a detour.
            </h1>

            <h2 className="font-fira text-3xl text-center">
