...
//         setisNotificationDrawerOpen] = useState(false)
...
//                     </BurgerMenu>
//                 )}
//                  <BurgerMenu right isOpen={isNotificationDrawerOpen} animation="slide" onStateChange={({ isOpen }) => setIsNotificationDrawerOpen(isOpen)}>
//                 <Notifications
