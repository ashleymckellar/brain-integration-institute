...
const AccordionCard = ({ certStatus }) => {
    ...
    return (
        <div className="flex flex-col md:flex-row justify-start items-start md:items-start pl-20">
            ...
            <div className="flex flex-col w-full md:w-auto">
                ...
                <div className="flex justify-center items-center">
                    <p className="font-fira text-lg md:text-xl font-light pt-10 md:pt-20 pb-5 md:pb-10 md:px-[290px] text-center">
                        ...
                        >
                            ...
                            >
                                ...
                                <h3 className="font-fira text-black text-sm md:text-base font-bold mt-4">
                                    Standard Knowledge Base Standard Knowledge
                                    Base
                                </h3>
                                <p className="mt-2">
                                    ...
                                    system. <br></br>Brain Integration Awareness
                                    and Systems: Learning the principles of
                                    brain integration, including how different
                                    parts of the brain communicate and work
                                    together. <br></br>Executive Functions:
                                    Studying the brain&apos;s higher-order
                                    processes, such as planning,
                                    decision-making, problem-solving, and
                                    impulse control. <br></br>
                                    Senses and Reflexes: Exploring how sensory
                                    input and reflex actions contribute to brain
                                    function and integration. <br></br>
                                    Techniques and Applications: Mastering
                                    various techniques for brain integration and
                                ...
                                <p className="mt-2">
                                    ...
                                    ethical guidelines and establishing
                                    appropriate boundaries in client
                                    relationships. <br></br>
                                    Good Business Practices: Implementing sound
                                    business practices, including client
                                    management, record-keeping, and financial
                                    responsibilities.
                                </p>
                                <h3 className="font-fira text-black text-sm md:text-base font-bold mt-4">
                                    Competency Base
                                ...
                                <p className="mt-2">
                                    ...
                                    Clinic Services: Providing comprehensive
                                    clinic services, from initial consultations
                                    to follow-up sessions.<br></br>{' '}
                                    Competency-Based Testing: Demonstrating
                                    proficiency through practical exams and
                                    assessments. <br></br>
                                    Certification: Successfully completing the
                                    certification process to become a recognized
                                    Brain Integration practitioner.<br></br>{' '}
                                    Upon completion of the 500-hour training,
